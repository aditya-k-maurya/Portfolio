						...
						<div className="row">
								...
								<div className="portfolio-item-inner shadow-dark">
									...
									<div className="portfolio-item-content">
										...
										<div className="portfolio-item-description">
											This is the current portfolio website to showcase my
											works. Made with blend of creativity and skills.
										</div>
								...
								<div className="portfolio-item-inner shadow-dark">
									...
									<div className="portfolio-item-content">
										...
										<div className="portfolio-item-description">
											...
											learning react or whenever I feel like to create
											something.
										</div>
							...
							<div className="portfolio-item padd-15">
								<div className="portfolio-item-inner shadow-dark">
									...
									<div className="portfolio-item-content">
										<h2 className="portfolio-item-heading">
											Techsnap frontend
										</h2>
										<ul className="portfolio-item-tags">
										...
										<div className="portfolio-item-description">
											Fully responsive Techsnap new website frontend. Made
											during my internship at Techsnap.
										</div>
							...
							<div className="portfolio-item padd-15">
								<div className="portfolio-item-inner shadow-dark">
									...
									<div className="portfolio-item-content">
										...
										<div className="portfolio-item-description">
											Created the landing page of UsabilityHub using html css to
											get grip on the frontend.
										</div>
